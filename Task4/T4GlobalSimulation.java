public class T4GlobalSimulation{
	...
	public static final int ARRIVAL = 1, DEPART = 2, MEASURE = 3; // The events, add or remove if needed!
	public static double time = 0; // The global time variable
	public static T4EventListClass eventList = new T4EventListClass(); // The event list used in the program
