...
public class Global{
	public static final int ARRIVAL = 1, READY = 2, MEASURE = 3, MEASUREC = 4, MEASURET = 5, WARMUP = 6;
	...
	public static double global_mean = 0.12;
	public static int global_method = RAND;
}
